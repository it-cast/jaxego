...
import { MoneyComponent, PaymentBadgeComponent } from '@jaxego/shared/components';
import { deliveryStateLabel, paymentMethodOf } from '@jaxego/shared/util/delivery-format';
import {
  EmptyStateComponent,
  ErrorStateComponent,
